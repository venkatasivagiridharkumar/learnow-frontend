...
const FEATURES = [
  ...
  { id:"JOBS BOARD", name:"Jobs Board", icon: (
  ...
  { id:"MY MENTOR", name:"My Mentor", icon: (
  ...
  { id:"JOIN COMMUNITY", name:"Join Community", icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-people-fill" viewBox="0 0 16 16">
      <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
    </svg>
  ),path:"/communities"},
  {id:"ABOUT US", name:"About Us", icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-three-dots" viewBox="0 0 16 16">
      <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 0 1 0-3 1.5 1.5 0 0 1 0 3"/>
    </svg>
  ),path:"/AboutUs"},
];
...
const HomeLeft = (props) => {
  ...
  const [username,setUsername]=useState("Un Defined")
  ...
  return (
    <aside className="home-left-container">
      <ul className="home-left-container-unordered-list">
        {FEATURES.map(item => (
          ...
          >
             <Link to={item.path} className={`home-left-container-list-item text-decoration-none ${activeId === item.id ? "active-tab" : ""}`}>
            {item.icon}
            <p>{item.name}</p> </Link>
          </li>
        ))}
      ...
      <div className="logout-container">
        ...
        <svg
          ...
          height="88"
          fill="currentColor"
          className="bi bi-box-arrow-left logout-button"
          viewBox="0 0 16 16"
